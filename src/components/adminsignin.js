...
export const Adminsignin = () => {
  ...
  return (
    ...
    <div className="container signinbox" style={{marginLeft:'910px'}}>
   <section className="bg-gray-50 dark:bg-gray-900 siginsection" style={{backgroundColor:'transparent', width: '600px'}}>
  <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 sectonexdiv">
      ...
      <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700" style={{marginLeft:'-100'}}>
